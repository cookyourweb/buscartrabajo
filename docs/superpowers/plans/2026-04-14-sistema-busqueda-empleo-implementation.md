...
NOTION_TOKEN = os.environ.get("NOTION_TOKEN", "ntn_G464872773099dpLY7OzD7I4ZeZee38rKHsoVlmCV2z7A0")
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "headerParameters": {
          "parameters": [
            {"name": "api-key", "value": "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"},
            {"name": "Content-Type", "value": "application/json"}
          ]
        },
        "sendBody": true,
...
4. Añadir `NOTION_TOKEN` con valor: `ntn_G464872773099dpLY7OzD7I4ZeZee38rKHsoVlmCV2z7A0`
